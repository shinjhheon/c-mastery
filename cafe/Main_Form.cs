...
namespace WindowsFormsApp1
{
    public partial class Main_Form : Form
    {
        ...
        private void button_Ice_Click(object sender, EventArgs e) // 아이스크림 버튼 누르면 리스트뷰에 뜨게 하는거
        {
            int count = listView_order.Items.Count; // 리스트뷰 항목 수 반환
            if (ord.icecount >= 2)
            {
                for (int i = 0; i < count; i++) // 리스트 뷰 내에서 검색하는 포문
                {
                    if (listView_order.Items[i].SubItems[0].Text == button_Ice.Text)

                    {
                        listView_order.Items[i].Focused = true; // 리스트뷰 컨트롤에서 항목 선택 가능하도록 하는거
                        listView_order.Items[i].Selected = true; // 리스트뷰 컨트롤에서 항목 선택 가능하도록 하는거
                        listView_order.FocusedItem.SubItems[0].Text = button_Ice.Text; // 포커스된 부분에 내용 덮어쓰는거
                        listView_order.FocusedItem.SubItems[1].Text = Convert.ToString(ord.icecount); // 포커스된 부분에 내용 덮어쓰는거
                        listView_order.FocusedItem.SubItems[2].Text = Convert.ToString(ord.IceSum()); // 포커스된 부분에 내용 덮어쓰는거
                        ord.icecount++;
                        listView_order.Items[i].Selected = false;
                    }
                }
            ...
            {
                var dessert = new string[] { this.button_Ice.Text, Convert.ToString(ord.icecount), Convert.ToString(ord.IceSum()) };
                var lvt = new ListViewItem(dessert);
                this.listView_order.Items.Add(lvt);
                listView_order.Focus();
                ord.icecount++;
        ...
        private void button_strawberry_Click(object sender, EventArgs e)// 딸기 요거트 블렌디드 버튼 누르면 리스트뷰에 뜨게하는거
        {
            int count = listView_order.Items.Count; // 리스트뷰 항목 수 반환
            if (ord.strawberrycount >= 2)
            {
                for (int i = 0; i < count; i++) // 리스트 뷰 내에서 검색하는 포문
                {
                    if (listView_order.Items[i].SubItems[0].Text == button_strawberry.Text)

                    {
                        listView_order.Items[i].Focused = true; // 리스트뷰 컨트롤에서 항목 선택 가능하도록 하는거
                        listView_order.Items[i].Selected = true; // 리스트뷰 컨트롤에서 항목 선택 가능하도록 하는거
                        listView_order.FocusedItem.SubItems[0].Text = button_strawberry.Text; // 포커스된 부분에 내용 덮어쓰는거
                        listView_order.FocusedItem.SubItems[1].Text = Convert.ToString(ord.strawberrycount); // 포커스된 부분에 내용 덮어쓰는거
                        listView_order.FocusedItem.SubItems[2].Text = Convert.ToString(ord.StrawberrySum()); // 포커스된 부분에 내용 덮어쓰는거
                        ord.strawberrycount++;
                        listView_order.Items[i].Selected = false;
                    }
                }
            ...
            {
                var coffee = new string[] { this.button_strawberry.Text, Convert.ToString(ord.strawberrycount), Convert.ToString(ord.StrawberrySum()) };
                var lvt = new ListViewItem(coffee);
                this.listView_order.Items.Add(lvt);
                listView_order.Focus();
                ord.strawberrycount++;
        ...
        private void button_mango_Click(object sender, EventArgs e)// 망고 바나나 블렌디드 버튼 누르면 리스트뷰에 뜨게하는거
        {
            int count = listView_order.Items.Count; // 리스트뷰 항목 수 반환
            if (ord.mangocount >= 2)
            {
                for (int i = 0; i < count; i++) // 리스트 뷰 내에서 검색하는 포문
                {
                    if (listView_order.Items[i].SubItems[0].Text == button_mango.Text)

                    {
                        listView_order.Items[i].Focused = true; // 리스트뷰 컨트롤에서 항목 선택 가능하도록 하는거
                        listView_order.Items[i].Selected = true; // 리스트뷰 컨트롤에서 항목 선택 가능하도록 하는거
                        listView_order.FocusedItem.SubItems[0].Text = button_mango.Text; // 포커스된 부분에 내용 덮어쓰는거
                        listView_order.FocusedItem.SubItems[1].Text = Convert.ToString(ord.mangocount); // 포커스된 부분에 내용 덮어쓰는거
                        listView_order.FocusedItem.SubItems[2].Text = Convert.ToString(ord.MangoSum()); // 포커스된 부분에 내용 덮어쓰는거
                        ord.mangocount++;
                        listView_order.Items[i].Selected = false;
                    }
                }
            ...
            {
                var coffee = new string[] { this.button_mango.Text, Convert.ToString(ord.mangocount), Convert.ToString(ord.MangoSum()) };
                var lvt = new ListViewItem(coffee);
                this.listView_order.Items.Add(lvt);
                listView_order.Focus();
                ord.mangocount++;
        ...
        private void button_Jeju_Click(object sender, EventArgs e)// 제주 감귤 당근 블렌디드 버튼 누르면 리스트뷰에 뜨게하는거
        {
            int count = listView_order.Items.Count; // 리스트뷰 항목 수 반환
            if (ord.jejucount >= 2)
            {
                for (int i = 0; i < count; i++) // 리스트 뷰 내에서 검색하는 포문
                {
                    if (listView_order.Items[i].SubItems[0].Text == button_Jeju.Text)

                    {
                        listView_order.Items[i].Focused = true; // 리스트뷰 컨트롤에서 항목 선택 가능하도록 하는거
                        listView_order.Items[i].Selected = true; // 리스트뷰 컨트롤에서 항목 선택 가능하도록 하는거
                        listView_order.FocusedItem.SubItems[0].Text = button_Jeju.Text; // 포커스된 부분에 내용 덮어쓰는거
                        listView_order.FocusedItem.SubItems[1].Text = Convert.ToString(ord.jejucount); // 포커스된 부분에 내용 덮어쓰는거
                        listView_order.FocusedItem.SubItems[2].Text = Convert.ToString(ord.JejuSum()); // 포커스된 부분에 내용 덮어쓰는거
                        ord.jejucount++;
                        listView_order.Items[i].Selected = false;
                    }
                }
            ...
            {
                var coffee = new string[] { this.button_Jeju.Text, Convert.ToString(ord.jejucount), Convert.ToString(ord.JejuSum()) };
                var lvt = new ListViewItem(coffee);
                this.listView_order.Items.Add(lvt);
                listView_order.Focus();
                ord.jejucount++;
            ...
            if (count == 0)
            {
                ...
                switch (dlr)
                {
                    case DialogResult.Yes:
                        ...
                        sto.jejucount += ord.jejucount - 1;
                        sto.cafemochahcount += ord.cafemochahcount - 1;
                        sto.strawberrycount += ord.strawberrycount - 1;
                        ...
                        sto.mangocount += ord.mangocount - 1;
                        sto.chococakecount += ord.chococakecount - 1;
                        sto.cheezecakecount += ord.cheezecakecount - 1;
                        sto.tiramisucount += ord.tiramisucount - 1;
                        sto.icecount += ord.icecount - 1;
                        sto.bagelcount += ord.bagelcount - 1;

                        sto.Stockopen();

                        if (sto[0] - sto.americanohcount - sto.cafelattehcount - sto.cafemochahcount - sto.strawberrycount - sto.americanoicount - sto.cafelatteicount - sto.cafemochaicount < 0) {
                            MessageBox.Show("현재 주문한 메뉴만큼 원두가 있지않습니다.");
                        }

                        if (sto[1] - sto.cafelattehcount - sto.jejucount - sto.cafemochahcount - sto.strawberrycount - sto.cafelatteicount - sto.cafemochaicount - sto.mangocount < 0)
                        {
                        ...
                        if (sto[3] - sto.strawberrycount - sto.mangocount < 0)
                        {
                            MessageBox.Show("현재 주문한 메뉴만큼 음료가 있지않습니다.");
                        }
                        ...
                        if (sto[8] - sto.icecount < 0)
                        {
                            MessageBox.Show("현재 주문한 메뉴만큼 바닐라 아이스크림이 있지않습니다.");
                        }
                        ...
                        if (sto[0] - sto.americanohcount - sto.cafelattehcount - sto.cafemochahcount - sto.strawberrycount - sto.americanoicount - sto.cafelatteicount - sto.cafemochaicount - sto.mangocount >= 0 && sto[1] - sto.cafelattehcount - sto.cafemochahcount - sto.strawberrycount - sto.cafelatteicount - sto.cafemochaicount - sto.mangocount >= 0 && sto[2] - sto.cafemochahcount - sto.cafemochaicount >= 0 &&
                            sto[3] - sto.strawberrycount - sto.mangocount >= 0 && sto[4] - sto.chococakecount >= 0 && sto[5] - sto.cheezecakecount >= 0 && sto[6] >= 0 && sto[7] - sto.tiramisucount >= 0 && sto[8] - sto.icecount >= 0 && sto[9] - sto.bagelcount >= 0 && sto[10] >= 0)
                        {
                            sto.Stockstart();
                            sto.Stocksave();
                        }

                        sto.americanohcount = 0; sto.cafelattehcount = 0; sto.jejucount = 0; sto.cafemochahcount = 0; sto.strawberrycount = 0; sto.americanoicount = 0; sto.cafelatteicount = 0; sto.cafemochaicount = 0; sto.mangocount = 0; sto.chococakecount = 0; sto.cheezecakecount = 0; sto.tiramisucount = 0; sto.icecount = 0; sto.bagelcount = 0;
                        ord.americanohcount = ord.cafelattehcount = ord.jejucount = ord.cafemochahcount = ord.strawberrycount = ord.americanoicount = ord.cafelatteicount = ord.cafemochaicount = ord.mangocount = ord.chococakecount = ord.cheezecakecount = ord.tiramisucount = ord.icecount = ord.bagelcount = 1;
                        ord.americanohsum = ord.cafelattehsum = ord.jejusum = ord.cafemochahsum = ord.strawberrysum = ord.americanoisum = ord.cafelatteisum = ord.cafemochaisum = ord.mangosum = ord.chococakesum = ord.cheezecakesum = ord.tiramisusum = ord.icesum = ord.bagelsum = 0;
            ...
            {                
                ...
                switch (dlr)
                {
                    case DialogResult.Yes:
                        ...
                        if (sto[3] - sto.strawberrycount - sto.mangocount < 0) // 나중에 수정
                        {
                            MessageBox.Show("현재 주문한 메뉴만큼 음료가 있지않습니다.");
                        ...
                        if (sto[0] - sto.americanohcount - sto.cafelattehcount - sto.cafemochahcount -  sto.americanoicount - sto.cafelatteicount - sto.cafemochaicount - sto.mangocount >= 0 && sto[1] - sto.cafelattehcount - sto.cafemochahcount - sto.strawberrycount - sto.cafelatteicount - sto.cafemochaicount - sto.mangocount >= 0 && sto[2] - sto.cafemochahcount - sto.cafemochaicount >= 0 &&
                            sto[3] - sto.strawberrycount - sto.mangocount >= 0 && sto[4] - sto.chococakecount >= 0 && sto[5] - sto.cheezecakecount >= 0 && sto[6] >= 0 &&  sto[7] - sto.tiramisucount >= 0 && sto[8] - sto.icecount >= 0 && sto[9] - sto.bagelcount >= 0 && sto[10] >= 0)
                        {
                            sto.Stockstart();
                            sto.Stocksave();
        ...
        private void button_cancel1_Click(object sender, EventArgs e)// 선택 취소
        {
            ...
            if (count == 0)
            {
                ...
                else if (listView_order.FocusedItem.SubItems[0].Text == button_Jeju.Text)
                {
                    ord.jejucount = 1;
                    ord.jejusum = 0;
                }
                ...
                else if (listView_order.FocusedItem.SubItems[0].Text == button_strawberry.Text)
                {
                    ord.strawberrycount = 1;
                    ord.strawberrysum = 0;

                }
                else if (listView_order.FocusedItem.SubItems[0].Text == button_mango.Text)
                {
                    ord.mangocount = 1;
                    ord.mangosum = 0;
                }
                ...
                else if (listView_order.FocusedItem.SubItems[0].Text == button_Ice.Text)
                {
                    ord.icecount = 1;
                    ord.icesum = 0;
                }
        ...
        public void stockError2()// 재고량 부족하면 알려주는건데 주문메뉴 사용시 사용되는데 재고 수정 검색시도 사용됨.
        {
            ...
            else if (sto[8] > 0) button_Ice.Enabled = true;
